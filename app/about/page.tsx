  ...
  return (
    <main>
      ...
      <section className="section quality-section">
        <div className="shell split-heading"><div><p className="eyebrow dark"><span />Quality & accreditation</p><h2>AgriSETA-accredited agricultural learning within a clearly defined scope.</h2><Link className="quality-partner" href="/agriseta"><span>View our accreditation</span><img src="/images/agriseta-logo.png" alt="AgriSETA logo" /></Link></div><div><p>AgriSETA has accredited Makabongwe to deliver agricultural courses within the institute&apos;s approved scope. We publish and deliver accredited learning only where it is supported by current accreditation documentation, and clearly distinguish it from non-credit-bearing practical workshops.</p><ul className="check-list"><li>AgriSETA-accredited delivery within the approved programme scope</li><li>Registered facilitators, assessors and moderators where required</li><li>Learner enrolment, attendance, assessment and moderation records</li><li>Health, safety, accessibility and biosecurity controls</li><li>Secure beneficiary data and consent-based evidence collection</li><li>Programme files, issue logs and close-out reporting</li></ul><Link href="/agriseta" className="text-link">See qualifications and validity <span>→</span></Link></div></div>
      </section>
    </main>
  );
}
