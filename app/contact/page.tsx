    ...
    <main>
      ...
      <section className="section contact-section" id="enquiry">
        <div className="shell contact-grid">
          <div className="contact-details"><p className="eyebrow dark"><span />Makabongwe Project (Pty) Ltd</p><h2>Let&apos;s build practical opportunity together.</h2><div className="contact-list"><article><span>Phone</span><a href="tel:+27812148384">+27 81 214 8384</a></article><article><span>Email</span><a href="mailto:hlakaniphanib@gmail.com">hlakaniphanib@gmail.com</a></article><article><span>Address</span><p>12A Chat Crescent<br />Birdswood, Richards Bay, 3900</p></article><article><span>Contact person</span><p>Mr H.P. Buthelezi<br />Owner & Managing Director</p></article></div><p className="response-note">Training can be delivered at Makabongwe facilities, partner venues, schools, farms, community halls, municipal sites or client premises, subject to suitability and safety assessment.</p></div>
